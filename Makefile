...
$(test_dir)uic_progress_bar.out: $(srcs) $(uic_srcs) ./tests_gl/uic_progress_bar.c
	$(CC) -o progress_bar.out ./tests_gl/uic_progress_bar.c $(srcs) $(uic_srcs) $(errors) $(libs) -g
clean:
	rm *.out
